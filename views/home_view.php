...
<!-- Start List of events from Query---!>
	...
	foreach ($query->result() as $row):?>
	 <td><div class="event">
		...
		<div class="event_date">
   			<?php $dia = substr($row->date, -2, 2);echo $dia; ?>
		</div>
		<div class="event_date_name">
		<?php
		$today = date("Y-m-d");
		$tomorrow = mktime(0, 0, 0, date("m"), date("d")+1, date("y"));
		$mañana = date("Y-m-d", $tomorrow); 
...
?>
	...
	<div class="event_time">
	  	<img src="<?php echo base_url()?>./images/icons/clocks.gif" height="30" width="30" />
	  	<?php echo $row->time; ?>

<br />
	  <strong> <img src="<?php echo base_url()?>./images/icons/dollar.png" height="25" width="25" />
		  <?php echo $row->price; ?><br /></strong>
	  </div>
	
	  <div class="event_link"><?php
	  	$link = ' <img src="'.base_url().'/images/icons/hyperlink.gif" height="35" width="35" />';
		  echo anchor($row->link, $link);?>
	   </div>
	   <div class="event_place">
		    <a href="http://maps.google.com/maps?q=<?php echo $row->geodata?>"><img src="<?php echo base_url()?>./images/icons/place.png" height="30" width="30" /> </a>
		    <?php echo $row->place; ?>
	    </div> 
