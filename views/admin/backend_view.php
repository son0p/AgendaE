<?php $this->load->view("inc/header")?>
	...
	<div id="backend">		
			...
			<p><div class="notable"><?php echo anchor('contactos/form', 'Insertar nuevo evento'); ?></div></p>
			...
			<tr>
			 ...
			 <div class="delete"><?php echo anchor('/backend/event_delete/'.$row->id,'BORRAR');?></div><br></td>
<td>
<?php echo anchor($row->link, '[Enlace]');?>
</td>
